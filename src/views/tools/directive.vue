<template>
  <div>
    <v-card style="height: 100vh">
      <a-alert banner message="为了拖拽流畅请在定位组件上包裹原生DOM，避免定位冲突"/>
      ...
      <p>关键词高亮</p>
      <a-input v-model:value="keyword" placeholder="请输入关键词"></a-input>
...
function onPosChanged(positionDiff: unknown, absolutePosition: unknown, event: unknown) {
}
